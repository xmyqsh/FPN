...
class FPN_alt_opt_train(Network):
    def __init__(self, trainable=True):
        ...
        # Fast-RCNN inputs
        self.leveled_rois_0 = tf.placeholder(tf.float32, shape=[None, 5], name='leveled_rois_0')
    ...
    def build_RPN_loss(self, vs_name):
        ############# RPN
        ...
        #vs_name = ['res3_5', 'Top-Down', 'RPN'] if stage == 1 else ['RPN']
    ...
    def build_Fast_RCNN_loss(self, vs_name):
        ############# R-CNN
        # classification loss
        ...
        #vs_name = ['res3_5', 'Top-Down', 'Fast-RCNN'] if stage == 1 else ['Fast-RCNN']
